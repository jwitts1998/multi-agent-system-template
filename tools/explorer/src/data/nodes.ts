...
export const nodes: ExplorerNode[] = [
  // ── Agent Roles ──
  { id: 'role-impl', type: 'agentNode', position: P, data: { name: 'Implementation Agent', description: 'Core development and implementation specialist. Writes production-ready code following architecture patterns. Identifies tooling gaps and recommends plugins, skills, or MCP servers.', category: 'agent-role', subcategory: 'Base Role' } },
  { id: 'role-qa', type: 'agentNode', position: P, data: { name: 'QA Agent', description: 'Code review and quality enforcement specialist. Reviews code for style, security, and architecture compliance. Evaluates plugin/skill/MCP coverage and flags missing capabilities.', category: 'agent-role', subcategory: 'Base Role' } },
  ...
  // ── Generic Subagents ──
  { id: 'gen-code-reviewer', type: 'agentNode', position: P, data: { name: 'code-reviewer', description: 'Reviews code for style, maintainability, security patterns, and architecture compliance. Audits for tooling & capability gaps — recommends plugins, custom skills, or MCP servers.', filePath: 'templates/subagents/generic/code-reviewer.md', category: 'generic' } },
  ...
  { id: 'gen-designer', type: 'agentNode', position: P, data: { name: 'designer', description: 'UI/UX and design system specialist. Enforces accessibility, responsiveness, and brand consistency. Reviews tooling gaps for design-to-code, accessibility scanning, and visual regression.', filePath: 'templates/subagents/generic/designer.md', category: 'generic' } },
  ...
  // ── System Agents ──
  { id: 'sys-query-router', type: 'agentNode', position: P, data: { name: 'query-router', description: 'Single entry point that triages user intent and delegates to the appropriate agent role via a delegation matrix.', filePath: 'templates/subagents/system/query-router.md', category: 'agent-role', subcategory: 'System' } },
  { id: 'sys-task-orchestrator', type: 'agentNode', position: P, data: { name: 'task-orchestrator', description: 'Manages task queue, assigns work to agents based on priority and dependencies, enforces execution order.', filePath: 'templates/subagents/system/task-orchestrator.md', category: 'agent-role', subcategory: 'System' } },
  { id: 'sys-memory-updater', type: 'agentNode', position: P, data: { name: 'memory-updater', description: 'Recursive memory updates across working, episodic, and semantic tiers. Archives sessions and promotes validated patterns.', filePath: 'templates/subagents/system/memory-updater.md', category: 'agent-role', subcategory: 'System' } },
  { id: 'sys-execution-monitor', type: 'agentNode', position: P, data: { name: 'execution-monitor', description: 'Monitors task execution for completion and failures, validates acceptance criteria, triggers recovery workflows.', filePath: 'templates/subagents/system/execution-monitor.md', category: 'agent-role', subcategory: 'System' } },
  ...
  { id: 'cfg-agents-base', type: 'configNode', position: P, data: { name: 'AGENTS.md (base)', description: 'Base agent definitions with 4 core roles, collaboration patterns, and plugin/skill/MCP awareness guidelines.', filePath: 'templates/agents/AGENTS-base.md', category: 'config', subcategory: 'agents' } },

  // ── Plugin & Skill Awareness ──
  { id: 'cfg-plugin-awareness', type: 'configNode', position: P, data: { name: 'Plugin Awareness Rule', description: 'Always-on .mdc rule for ambient plugin, skill, and MCP gap detection during any task. Primes agents to notice missing tooling.', filePath: 'templates/cursorrules/rules/plugin-and-skill-awareness.mdc', category: 'config', subcategory: 'cursorrules' } },
  { id: 'cfg-cursor-plugins', type: 'configNode', position: P, data: { name: 'CURSOR_PLUGINS.md', description: 'Inventory of installed plugins, skills, and MCP servers. Includes gap identification guidelines for when to install, create, or expose new capabilities.', filePath: 'docs/CURSOR_PLUGINS.md', category: 'config', subcategory: 'docs' } },
